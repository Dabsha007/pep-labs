...
public class Runner {
    static String  global_var = in; // here i added this line of code
    /**
     ...
     */
    public static void changeClassVar(String in){ // here i added static keyword 
        String static global_var = in; //i added this line of code
